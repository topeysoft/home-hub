...
<template>
  <div class="sheet-back" @click.self="store.sheet = null">
    <div class="sheet look" role="dialog" aria-label="How the house looks">
      <button class="back sheet-close" @click="store.sheet = null" aria-label="Close"><Icon name="close" :size="18" /></button>
      <h2 class="display">How the house looks</h2>
      <p class="sheet-lede">Everyone sees what you pick here, on every screen in the house.</p>
      ...
      <p class="sheet-foot">The cards take their colour from the sky, so all of these lighten through the morning and settle after sunset. The tone sets which way they lean.</p>
    </div>
  </div>
</template>
