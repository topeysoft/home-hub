 ...
 * is tabs across the top and the household along the bottom, which gives the
...
export const NAVS: { id: NavName; label: string; hint: string }[] = [
  ...
  { id: 'top', label: 'Top', hint: 'Tabs across the top, the household along the bottom. Room for what is on.' },
]
