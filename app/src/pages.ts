...
export type PageId = 'house' | 'location' | 'look' | 'routines' | 'people' | 'add' | 'hub' | 'code' | 'notes'
export const PAGES: PageId[] = ['house', 'location', 'look', 'routines', 'people', 'add', 'hub', 'code', 'notes']
