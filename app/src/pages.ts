...
export type PageId = 'house' | 'location' | 'look' | 'routines' | 'signals' | 'people' | 'accounts' | 'things' | 'add' | 'share' | 'hub' | 'code' | 'notes' | 'happened' | 'changes'
export const PAGES: PageId[] = ['house', 'location', 'look', 'routines', 'signals', 'people', 'accounts', 'things', 'add', 'share', 'hub', 'code', 'notes', 'happened', 'changes']
