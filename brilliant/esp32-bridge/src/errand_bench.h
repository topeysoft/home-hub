...
//   drop               let go now
//
// The relay that used to live here spoke a binary format the brain could never have sent. The one
// that ships is errand.{h,cpp}, and it runs in this build too.
